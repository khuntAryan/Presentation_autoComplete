...
def log_description(mapping: Dict[str, List[str]], slide_overviews, naming_desc):
    ...
    desc.append("3.1 give the content in text format only")
    desc.append("4. Example:")
    desc.append("   Slide 2: Objectives")
    desc.append("   this is the content of the first placeholder (max 50 characters)")
    desc.append("   this is the content of the second placeholder (max 100 characters)")
    desc.append("   and also give the content in text format")
    desc.append("\n=== PLACEHOLDER LIST ===")
