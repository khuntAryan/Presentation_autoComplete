...
export declare class Hyperlink extends Shape {
    ...
    prepare(targetTemplate: RootPresTemplate, targetSlideNumber: number, hyperlinks?: Target[]): Promise<void>;
    ...
    modifyOnAddedSlide(targetTemplate: RootPresTemplate, targetSlideNumber: number, hyperlinks?: Target[]): Promise<void>;
    static addHyperlinkToShape(archive: IArchive, slidePath: string, slideRelsPath: string, shapeId: string, hyperlinkTarget: string, isExternal?: boolean): Promise<string>;
}
